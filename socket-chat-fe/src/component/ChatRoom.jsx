    ...
    return (
        <div className="py-4 m-5 w-50 shadow bg-white text-dark border rounded container">
            <div className="text-center px-3 mb-4 text-capitalize">
                <h1 className="text-warning mb-4">{data && data.room && `${data.room} Chat Room`}</h1>
            </div>
                    ...
                    allMessages.map(msg => {
                        return data.name === msg.name
                            ...
                            <div className="row justify-content-start">
                                <div className="d-flex flex-column align-items-end m-2 p-2 shadow bg-white border rounded w-auto">
                                    <div>
                                        <strong className="m-1">{msg.name}</strong>
